...
export default function CheckOut() {
  ...
  return (
    <React.Fragment>
      <div className="checkout d-flex justify-content-around ">
        <div className="left">
          {" "}
          <div className="shopping-address ">
            ...
            {localStorage.getItem("userAddress") ? (
              ...
              <div className="user-adddress d-flex justify-content-between">
                <div>
                  <h5 className=" fw-normal">
                    {" "}
          ...
          <div className="payment-method">
            ...
            {localStorage.getItem("userPayment") ? (
              <div className="user-adddress ">
                ...
                <h5 className="fw-normal">
                  {" "}
                  <i className="fa-sharp fa-solid fa-square me-2"></i>Billing
              ...
              <div className="user-adddress d-flex justify-content-between">
                <div>
                  <h5 className="fw-normal">
                    ...
                    Mastercard ending in {AddUserPayment.Expiry_Date}{" "}
                  </h5>
                  <h5 className="fw-normal">
                    <i className=" fa-solid  fa-gift me-2"></i> $ 53.21 gift
                    card balance{" "}
                  </h5>
                  <h5 className="fw-normal">
                    {" "}
